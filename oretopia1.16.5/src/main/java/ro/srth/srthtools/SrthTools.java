...
import ro.srth.srthtools.block.ModBlocks;
import ro.srth.srthtools.item.ModItems;
/* im sorry can i have the kids back now */
import java.util.stream.Collectors;

// The value here should match an entry in the META-INF/mods.toml file
@Mod(SrthTools.MOD_ID)
public class SrthTools
{
    public static final String MOD_ID = "srthtools";
